# VithyarthiProject - Voice Assistant

VithyarthiProject is a simple Python-based voice assistant that can play songs, tell the time, fetch Wikipedia summaries, tell jokes, and more using voice commands. It uses speech recognition and text-to-speech to interact with the user.
...
2. Run the script:
   ...
   ```sh
   python VithyarthiProject.py
   ```

3. Say "Alexa" followed by your command.  
   Example commands:
